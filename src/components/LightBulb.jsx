const LightBulb = ({
	...
	return (
		...
		>
			<path
				fill="#000000"
				d="M296.422,384h-80.844C197.906,384,192,398.328,192,416v19.203c0,10.773,1.461,19.836,9.625,25.637   c1.855,28.457,25.18,51.16,56.48,51.16s51.467-22.703,53.322-51.16c8.164-5.801,8.572-14.863,8.572-25.637V416   C320,398.328,314.094,384,296.422,384z"
			/>
			<path
				style={{
					fill: state ? (color === "#ffffff" ? "#e3e3e3" : color) : "#000000",
					filter: `brightness(${bri / 2.55}%)`,
				}}
